    ...
    public static void main(String[] args) {
       ...
       // info.printStudentOverGrade(students, 8);
        ...
        info.testStudent(students, new StudentChecks() {
            // так краще прописувати реалізацію відразу там де визиваємо інтрфейс тобто
            // робимо анонімний клас просто не треба створювати таке що ми використаємо всьоо один раз
            @Override
...
// так було прописали реалізацію інетерфейсу і визиваємо клас в якому вона прописана
